       ...
       <form action="gravar.php"  method="POST">
        <div class="form-row">
            <div class="form-group col-md-6"> <br>
              ...
              <input name="nome" type="text" class="form-control" id="nome" placeholder="Ex: João">
            </div>
          <div class="form-group col-md-6"> <br>
            <label for="sobrenome">Sobrenome</label> 
          <input name ="sobrenome" type="text" class="form-control" id="sobrenome" placeholder="Ex: Silva">
          </div>
        </div>
      <div class="form-row">
          <div class="form-group col-md-6">
            <label for="telefone">Telefone</label>
            <input name="telefone" type="text" class="form-control" id="telefone" placeholder="Ex:(xx) xxxx-xxxx">
          </div>
          <div class="form-group col-md-6">
            <label for="celular">Celular</label>
            <input name="celular" type="text" class="form-control" id="celular" placeholder="Ex:(xx) xxxxx-xxxx">
          </div>
      </div>

        <div class="form-group">
          <label for="email">Email</label>
          <input name="email" type="email" class="form-control" id="email" placeholder="joaosilva@gmail.com">
        </div>
